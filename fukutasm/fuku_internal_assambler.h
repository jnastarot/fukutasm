...
#define asm_def_shXd_inst(name) \
    ...
    asm_def_2op(name##_cl,_w,fuasm_reg, fuasm_reg)\
    asm_def_2op(name##_cl,_w,fuasm_op, fuasm_reg)\
\
    asm_def_3op(name,_dw,fuasm_reg, fuasm_reg, fuasm_imm)\
    asm_def_3op(name,_dw,fuasm_op, fuasm_reg, fuasm_imm)\
    asm_def_2op(name##_cl,_dw,fuasm_reg, fuasm_reg)\
    asm_def_2op(name##_cl,_dw,fuasm_op, fuasm_reg)\
\
    asm_def_3op(name,_qw,fuasm_reg, fuasm_reg, fuasm_imm)\
    asm_def_3op(name,_qw,fuasm_op, fuasm_reg, fuasm_imm)\
    asm_def_2op(name##_cl,_qw,fuasm_reg, fuasm_reg)\
    asm_def_2op(name##_cl,_qw,fuasm_op, fuasm_reg)
...
#define asm_def_movsxz(name) \
    ...
    asm_def_2op(name,_byte_w, fuasm_reg, fuasm_op)\
    asm_def_2op(name,_byte_dw, fuasm_reg, fuasm_reg)\
    asm_def_2op(name,_byte_dw, fuasm_reg, fuasm_op)\
    asm_def_2op(name,_byte_qw, fuasm_reg, fuasm_reg)\
    asm_def_2op(name,_byte_qw, fuasm_reg, fuasm_op)\
\
    asm_def_2op(name,_word_dw, fuasm_reg, fuasm_reg)\
    asm_def_2op(name,_word_dw, fuasm_reg, fuasm_op)\
\
    asm_def_2op(name,_word_qw, fuasm_reg, fuasm_reg)\
    asm_def_2op(name,_word_qw, fuasm_reg, fuasm_op)

class fuku_internal_assambler{
...
public:
    fuku_internal_assambler(fuku_assambler_arch arch);
    ~fuku_internal_assambler();
...
#undef asm_def_shXd_inst
#undef asm_def_direct_mov
#undef asm_def_movsxz