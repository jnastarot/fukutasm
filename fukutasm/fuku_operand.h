...
public:
    explicit fuku_operand(fuku_register base, fuku_operand_size size);   // [base]
    ...
    fuku_operand(fuku_register base, const fuku_immediate& disp, fuku_operand_size size);  // [base + disp/r]
    fuku_operand(fuku_register base, fuku_register index, fuku_operand_scale scale, const fuku_immediate& disp, fuku_operand_size size);// [base + index*scale + disp/r]
    fuku_operand(fuku_register index, fuku_operand_scale scale, const fuku_immediate& disp, fuku_operand_size size);// [index*scale + disp/r]
...
#define OPERAND_PTR_DEF(name, size) \
    namespace fukutasm {\
    inline fuku_operand name(fuku_register base) {\
